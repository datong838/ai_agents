...
| Rule | 本方案约束 |
|---|---|
| 文档先于编码 | 本方案及首个领域方案未评审冻结前，不开始资产注册中心或电商 G0 编码 |
...
| M5 首包验证 | 电商 core/growth + Niushop pack 的 dry install | 不生产写回 | 安装、Evals、卸载/回滚、累计回归通过 |

M0～M4 是平台基础，优先于电商 G0；M5 与电商 G0 的第一小波对接。
