...
> **版本**：v1.33 · 2026-08-04
> **状态**：🟡 TI-1 E3 非生产工程完成、TI-PRE-1/TI-2 E1～E7/TI-3 E1～E7 GREEN；59 条逻辑 QUARANTINE 使 TI-1 E4 继续 BLOCKED；下一执行域为 TI-4 Data OS 与 Connector
...
TI-4 C1 已完成只读 precheck 并按连续执行授权进入实施：5 张电商 Connector 真源表均为 0 行，已具备 `org_id/workspace_id` 非空复合主键，但缺少到 `twa_workspace(org_id, project_id)` 的父级 FK，且 RLS 尚未启用。C1 仅新增 5 个 NOT VALID workspace alias FK；4 个 Object ingest writer 的 scope 丢失留给 C2，不连接具体商城。独立方案见《228-TI-4-C1-电商Connector工作区外键扩展实施方案》。
