...
> **版本**：v1.5 · 2026-08-04
> **状态**：🟢 TI-1 E1 GREEN；公共 TenantScope、nullable expand、7 个 NOT VALID FK 和 schema lint 已完成；下一步 TI-1 E2 需单独评审，未授权双写、回填、读切换、RLS 强制、删除或客户数据迁移
...
评审通过后的第一阶段 **TI-0** 已全部完成；TI-1 E1 也已按单独授权完成 nullable expand。下一步为 TI-1 E2 方案评审；当前不自动授权双写、回填、读切换、RLS 强制或 contract。
