...
> **版本**：v1.10 · 2026-08-04
> **状态**：🟢 TI-1 E2 GREEN；首批 authz 新写的 OFF/SHADOW/ENFORCE 双写与差异 ledger 已完成，默认仍为 OFF；未授权历史回填、读切换、RLS 强制、删除或客户数据迁移
...
- 下一门为 TI-1 E3 历史归属/隔离区方案评审；E3 会处理历史数据，未获得单独授权前不执行。
