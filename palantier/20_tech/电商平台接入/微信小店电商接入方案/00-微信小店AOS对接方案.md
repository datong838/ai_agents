...
> 状态：**平台适配方案 v0.2 · WX0 文档核验 YELLOW · 客户账号实测待完成 · 未开发**
> Bundle：`platform.ecommerce.wechat-shop`
> 关联产品方案：[新电商达人增长与控价任务产品方案](../228-新电商达人增长与控价任务产品方案.md)
> API 证据矩阵：[01-微信小店API能力清单](01-微信小店API能力清单.md)
...
截至 2026-08-03，官方文档已确认店铺、商品、订单、售后、商家已有带货者、已知达人详情、达人商品数据、推广计划达人、罗盘和橱窗商品等只读能力；客户账号、权限集、联盟开通状态、限流和真实响应仍未实测。官方证据尚不能证明全平台达人广场搜索、粉丝数/受众年龄/开播率筛选、联系方式读取或自动邀约能力，详见 API 能力清单。
...
| 达人发现 | 已确认商家已有带货者和已知达人补全；全平台搜索及粉丝/年龄/开播筛选未确认 | 平台后台人工导出/录入 |
| 达人合作 | 已确认部分推广计划/商品表现读取；邀请接口未确认 | 只生成任务与草稿，不自动发送 |
| 佣金 | 通用/定向佣金、结算、退款回退 | 人工录入并标记来源 |
| 直播/效果 | 开播、场次、GMV、订单、转化 | unavailable，不以 0 代替 |
| 消息/联系 | 官方证据未确认达人联系方式或自动外联接口 | 人工平台内操作 |
...
WX0 的官方文档清单已经冻结，但尚未 GREEN，不直接写 Connector。下一步由客户提供商家/服务商身份、测试店铺、优选联盟状态、权限集截图、受控凭据引用、已知达人/商品测试标识和回调配置，按 `01-微信小店API能力清单.md` 完成最小只读实测；只有拟进入 WX1 的能力达到 `LIVE_VERIFIED` 后，才编写 WX1 Connector 实施方案。
