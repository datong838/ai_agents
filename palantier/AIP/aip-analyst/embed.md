> Source: https://www.palantir.com/docs/foundry/aip-analyst/embed/
...
- 
- 
- AIP Analyst • Embed AIP Analyst • Palantir
- 
- 
- 
- 
...
- [Getting started](https://www.palantir.com/docs/foundry/threads/getting-started/)[AI Platform (AIP)](https://www.palantir.com/docs/foundry/aip/overview/)[AIP Analyst](https://www.palantir.com/docs/foundry/aip-analyst/overview/)[Embed AIP Analyst](https://www.palantir.com/docs/foundry/aip-analyst/embed/)

# [](https://www.palantir.com#embed-aip-analyst)Embed AIP Analyst
...
For a deeper integration inside Workshop modules, see the [AIP Analyst Workshop widget](https://www.palantir.com/docs/foundry/aip-analyst/workshop-widget/).

## [](https://www.palantir.com#control-which-data-aip-analyst-can-access)Control which data AIP Analyst can access
...
## [](https://www.palantir.com#pre-load-the-session)Pre-load the session

Pre-fill the user&#x27;s first message, or pre-load [context](https://www.palantir.com/docs/foundry/aip-analyst/using-aip-analyst/#context) so users start with relevant resources already available:
...
## [](https://www.palantir.com#view-options)View options
...
[←PREVIOUSWorkshop widget](https://www.palantir.com/docs/foundry/aip-analyst/workshop-widget/)[NEXTAIP Assist / Overview→](https://www.palantir.com/docs/foundry/assist/overview/)
...
- [Embed AIP Analyst](https://www.palantir.com#embed-aip-analyst)
- [Control which data AIP Analyst can access](https://www.palantir.com#control-which-data-aip-analyst-can-access)
- [Pre-load the session](https://www.palantir.com#pre-load-the-session)
- [View options](https://www.palantir.com#view-options)
