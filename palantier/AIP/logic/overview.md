> Source: https://www.palantir.com/docs/foundry/logic/overview/
...
- [Getting started](https://www.palantir.com/docs/foundry/threads/getting-started/)[AI Platform (AIP)](https://www.palantir.com/docs/foundry/aip/overview/)[AIP Logic](https://www.palantir.com/docs/foundry/logic/overview/)[Overview](https://www.palantir.com/docs/foundry/logic/overview/)

# [](https://www.palantir.com#aip-logic)AIP Logic
...
![](images/overview_logic-overview.png)

Logic functions can also be [automated](https://www.palantir.com/docs/foundry/automate/overview/) so that [Ontology edits can be automatically applied or staged for human review](https://www.palantir.com/docs/foundry/logic/aip-logic-integration-automate/).
...
![](images/overview_block-use-llm-prompt.png)
...
Learn more about the [core concepts](https://www.palantir.com/docs/foundry/logic/core-concepts/) of AIP Logic or [get started](https://www.palantir.com/docs/foundry/logic/getting-started/) with building a Logic function.
[←PREVIOUSAIP Evals / View results in metrics dashboard](https://www.palantir.com/docs/foundry/aip-evals/metrics-dashboard/)[NEXTCore concepts→](https://www.palantir.com/docs/foundry/logic/core-concepts/)
