---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/code-repositories/readme/",
  "title": "文档",
  "page_id": "readme",
  "category_id": "data-integration",
  "section_id": "code-repositories",
  "previous": "/zh/foundry/code-repositories/libraries/",
  "next": "/zh/foundry/code-repositories/aip-features/",
  "scraped_at": "2026-07-13T06:00:13.308267+00:00"
}
---
...
为了上传图片到代码库，您需要[在本地克隆您的代码库](/zh/foundry/transforms-python/local-development/)，将图片文件添加到本地代码库，然后推送更改到服务器。
...
要创建指向代码库中文件的链接，请使用`repo://`协议后跟文件路径；例如，`repo://transforms-python/src/myproject/datasets/examples.py`。这样引用的文件在点击时将自动打开。这使您可以轻松引用和导航到代码库中的其他文件。
