---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/compute-modules/usage/",
  "title": "计算模块使用和定价",
  "page_id": "usage",
  "category_id": "data-integration",
  "section_id": "compute-modules",
  "previous": "/zh/foundry/compute-modules/overview/",
  "next": "/zh/foundry/compute-modules/authoring-foundry/",
  "scraped_at": "2026-07-13T06:02:13.101913+00:00"
}
---
...
计算模块使用情况以 Foundry 计算秒为单位进行跟踪（参见[使用类型](/zh/foundry/resource-management/usage-types/)）。只要一个副本正在起始或处于活动状态，就会测量计算秒。计算秒使用的判断有几个因素：
...
![扩展](/resources/foundry/compute-modules/compute-module-scaling.png)
...
![CPU](/resources/foundry/compute-modules/compute-module-cpu-config.png)
