---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/data-connection/oidc/",
  "title": "OpenID Connect (OIDC) 身份验证",
  "page_id": "oidc",
  "category_id": "data-integration",
  "section_id": "data-connection",
  "previous": "/zh/foundry/data-connection/agents-troubleshooting/",
  "next": "/zh/foundry/data-connection/set-up-source/",
  "scraped_at": "2026-07-13T05:30:42.190632+00:00"
}
---
...
[OpenID Connect (OIDC) ↗](https://openid.net/developers/how-connect-works/)，也称为OIDC，是一种开放的身份验证协议，允许您在不使用静态凭据的情况下对外部源资源进行身份验证。
...
* [Azure Data Lake Storage Gen2 (Azure Blob Storage)](/zh/foundry/available-connectors/azure-blob-filesystem/)
* [BigQuery](/zh/foundry/available-connectors/bigquery/)
* [Google Cloud Storage](/zh/foundry/available-connectors/google-cloud-storage/)
* [S3](/zh/foundry/available-connectors/amazon-s3/)
...
应该使用 `source-rid` 来筛选传入的请求，以便不受信任的 Foundry 源无法访问您的资源。
