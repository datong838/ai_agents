---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/data-connection/overview/",
  "title": "概述",
  "page_id": "overview",
  "category_id": "data-integration",
  "section_id": "data-connection",
  "previous": "/zh/foundry/data-integration/views/",
  "next": "/zh/foundry/data-connection/core-concepts/",
  "scraped_at": "2026-07-13T05:30:22.396868+00:00"
}
---
...
![Foundry 侧边栏中的 Data Connection 应用程序。](../../../images/foundry/data-connection/data-connection-sidebar.png)

您还可以通过在应用程序门户中搜索来找到 Data Connection 应用程序。

![在应用程序门户中找到的 Data Connection 应用程序](../../../images/foundry/data-connection/data-connection-app-portal.png)

如果您是首次将 Foundry 连接到您的组织数据，请参阅[初始设置指南](/zh/foundry/data-connection/initial-setup-overview/)开始。
...
[了解有关可用源类型的完整范围的更多信息。](/zh/foundry/data-integration/source-type-overview/)
