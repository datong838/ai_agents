---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/data-lineage/navigation/",
  "title": "导航",
  "page_id": "navigation",
  "category_id": "data-integration",
  "section_id": "data-lineage",
  "previous": "/zh/foundry/data-lineage/overview/",
  "next": "/zh/foundry/data-lineage/faq/",
  "scraped_at": "2026-07-13T06:02:24.466406+00:00"
}
---
...
![数据沿袭](../../../images/foundry/data-lineage/data-lineage-ui-reference.png)
...
要了解有关分支的更多信息，请参阅[分支文档](/zh/foundry/data-integration/branching/)。
...
[了解更多关于管理搭建的信息。](/zh/foundry/data-lineage/build-datasets/)

### 管理计划

计划助手允许您设置和编辑图表中选定资源的搭建计划。
[了解更多关于搭建计划的信息。](/zh/foundry/building-pipelines/scheduling-overview/)
...
* **数据健康：** 选定数据集上设置的所有[健康检查](/zh/foundry/data-health/overview/)。
...
[阅读更多关于节点着色选项的信息。](/zh/foundry/data-lineage/node-coloring/)
...
使用**展开**工具揭示图表中节点的祖先和后代。[了解更多关于探索数据沿袭的信息。](/zh/foundry/data-lineage/explore-lineage/)
