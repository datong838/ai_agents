---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/maintaining-pipelines/support-processes/",
  "title": "推荐的支持流程",
  "page_id": "support-processes",
  "category_id": "data-integration",
  "section_id": "maintaining-pipelines",
  "previous": "/zh/foundry/maintaining-pipelines/define-data-expectations/",
  "next": "/zh/foundry/maintaining-pipelines/monitoring-views-intro/",
  "scraped_at": "2026-07-13T05:44:45.256406+00:00"
}
---
...
* 定义警报机制。更多信息请参见[下文](#alerting-mechanisms)。
* 定义支持轮换时间表。
  * 支持轮换持续多长时间，交接应该在哪一天进行？
  * （如果您使用外部工具，如Pagerduty）您是否需要一个次要的值班轮换时间表，以防主要值班人员错过警报？
* 准备数据管道文档。
  * 应该很容易找到文档所在位置。一个好的位置示例是在Foundry中，将文档放在项目的顶级`documentation`文件夹中，即数据管道关键输出所在的位置。
  * 文档应包括：
    * 数据管道的目的概述、输出的使用方式、组织期望和SLA。
    * 数据管道的最新[数据沿袭](/zh/foundry/data-lineage/overview/)图。
...
* **订阅[检查组摘要](/zh/foundry/data-health/check-groups-overview/)：** 检查组应包括您希望在数据管道中监控的所有健康检查。
