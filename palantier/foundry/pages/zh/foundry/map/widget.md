---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/map/widget/",
  "title": "在 Workshop 模块中嵌入地图模板",
  "page_id": "widget",
  "category_id": "ontology",
  "section_id": "map",
  "previous": "/zh/foundry/map/templates/",
  "next": "/zh/foundry/map/settings/",
  "scraped_at": "2026-07-14T05:04:40.677728+00:00"
}
---
...
[地图模板](/zh/foundry/map/templates/)可以嵌入到 Workshop 模块中。它们的参数值可以直接从 Workshop 变量中传递。

将地图模板嵌入 Workshop 模块中有三个步骤：

1. [在 Workshop 中添加地图应用模板微件](#add-a-map-application-template-widget-in-workshop)
...
![添加地图应用模板微件](../../../images/foundry/map/workshop-adding-widget.png)
...
* **时间配置**
  * **选定时间：** 使用 Workshop 类型为 `Timestamp` 或 `Date` 的变量控制选定时间。
  * **时间窗口：** 使用两个 Workshop 类型为 `Timestamp` 或 `Date` 的变量控制时间窗口。
* **界面**
  * **工具栏：** 显示工具栏。
