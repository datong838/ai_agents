---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-expression/getNthChainFromPolygonV1/",
  "title": "多边形中的第N链",
  "page_id": "getNthChainFromPolygonV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-expression",
  "previous": "/zh/foundry/pb-functions-expression/notV1/",
  "next": "/zh/foundry/pb-functions-expression/linestringPointNV1/",
  "scraped_at": "2026-07-13T05:56:49.963247+00:00"
}
---
...
* **N** - 要检索的环的索引。索引从1开始，索引为0表示超出范围。索引大于1返回内部环。<br>*Expression\<Byte | Integer | Long | Short>*
* **Polygon** - 要检索第n个环的多边形。<br>*Expression\<Geometry>*
