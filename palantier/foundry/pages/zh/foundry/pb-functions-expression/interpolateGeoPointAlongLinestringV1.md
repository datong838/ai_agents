---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-expression/interpolateGeoPointAlongLinestringV1/",
  "title": "在折线段上插值地理点",
  "page_id": "interpolateGeoPointAlongLinestringV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-expression",
  "previous": "/zh/foundry/pb-functions-expression/sha256V1/",
  "next": "/zh/foundry/pb-functions-expression/isNaNV1/",
  "scraped_at": "2026-07-13T05:55:55.634958+00:00"
}
---
...
* **Fraction** - 在折线段总长度上从起始点开始抽取地理点的比例。必须是介于0和1之间的浮点数。<br>*表达式\<Decimal | Double | Float>*
* **Linestring** - 用于插值地理点的折线段。<br>*表达式\<Geometry>*
...
**描述**: Fraction值为0时返回起始点的GeoPoint，Fraction值为1时返回终点的GeoPoint。存在浮点数误差，但应足够精确以满足几乎所有应用案例。
**参数值:**
