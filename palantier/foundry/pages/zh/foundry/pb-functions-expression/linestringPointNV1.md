---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-expression/linestringPointNV1/",
  "title": "线串中的第n个点",
  "page_id": "linestringPointNV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-expression",
  "previous": "/zh/foundry/pb-functions-expression/getNthChainFromPolygonV1/",
  "next": "/zh/foundry/pb-functions-expression/nullifyEmptyStringV1/",
  "scraped_at": "2026-07-13T05:56:42.228471+00:00"
}
---
...
* **Linestring** - 要检索第n个点的线串。<br>*Expression\<Geometry>*
* **N** - 要检索的点的索引。索引是基于1的，索引0是越界的。负索引从线串的末尾向后计数，因此-1是最后一个点。<br>*Expression\<Byte | Integer | Long | Short>*
