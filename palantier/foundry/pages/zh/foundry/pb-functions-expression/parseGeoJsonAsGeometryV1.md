---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-expression/parseGeoJsonAsGeometryV1/",
  "title": "从非WGS 84坐标系解析GeoJSON",
  "page_id": "parseGeoJsonAsGeometryV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-expression",
  "previous": "/zh/foundry/pb-functions-expression/pdfTableOfContentsV1/",
  "next": "/zh/foundry/pb-functions-expression/cbacStringToGroupNamesV1/",
  "scraped_at": "2026-07-13T05:56:39.992623+00:00"
}
---
...
* **GeoJSON字符串** - 作为字符串的GeoJSON。请注意，并非所有GeoJSON字符串都可以被Ontology索引；使用“规范化几何”表达式在Ontology使用之前准备几何。<br>*Expression<字符串>*
* **源坐标系** - 以“authority:id”格式的坐标系标识符。例如，UTM 18N区可以通过EPSG:32618标识。<br>*Literal<字符串>*
