---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-expression/polygonToH3V1/",
  "title": "获取覆盖几何图形的H3索引",
  "page_id": "polygonToH3V1",
  "category_id": "data-integration",
  "section_id": "pb-functions-expression",
  "previous": "/zh/foundry/pb-functions-expression/h3IndexExpressionV1/",
  "next": "/zh/foundry/pb-functions-expression/xzCurveEncodeV1/",
  "scraped_at": "2026-07-13T05:55:20.314758+00:00"
}
---
...
* **覆盖类型** - 指定多边形的H3覆盖类型。<br>*枚举\<Centroid, Inner, Outer>*
* **几何图形** - GeoJSON类型的多边形、线或点。<br>*表达式\<Geometry>*
* **分辨率** - H3网格分辨率在0到15之间（含）。<br>*表达式\<Byte | Integer | Long | Short>*
