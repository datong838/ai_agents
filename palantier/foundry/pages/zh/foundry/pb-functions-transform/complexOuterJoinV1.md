---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/complexOuterJoinV1/",
  "title": "外部合并",
  "page_id": "complexOuterJoinV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/outerCachingJoinV3/",
  "next": "/zh/foundry/pb-functions-transform/pivotV1/",
  "scraped_at": "2026-07-13T05:58:51.647393+00:00"
}
---
...
* **选择左侧列的条件** - 将测试左侧输入模式中的所有列，以查看它们是否满足此条件。如果满足，列将被选入输出。<br>*ColumnPredicate*
* **选择右侧列的条件** - 将测试右侧输入模式中的所有列，以查看它们是否满足此条件。如果满足，列将被选入输出。<br>*ColumnPredicate*
