---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/geoDistanceInnerJoinV1/",
  "title": "地理距离内合并",
  "page_id": "geoDistanceInnerJoinV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/fpGrowthV1/",
  "next": "/zh/foundry/pb-functions-transform/geoDistanceLeftJoinV1/",
  "scraped_at": "2026-07-13T05:58:30.369718+00:00"
}
---
...
* **选择左侧列的条件** - 将测试左侧输入模式中的所有列以查看它们是否符合此条件。如果符合，该列将被选中输出。<br>*ColumnPredicate*
* **选择右侧列的条件** - 将测试右侧输入模式中的所有列以查看它们是否符合此条件。如果符合，该列将被选中输出。<br>*ColumnPredicate*
* **距离** - 在此距离内合并几何，单位与坐标参考系统相同。<br>*Literal\<DefiniteNumeric>*
* **合并键** - 左右输入中的geojson列用于合并。<br>*Tuple\<Column\<Geometry>, Column\<Geometry>>*
* **左侧数据集** - 用于合并的左侧数据集。<br>*Table*
* **投影坐标系统** - 输入几何将在合并前转换为此坐标系统，并在给定坐标系统的单位中测量距离。格式为"authority:id"，例如UTM区域18N可以通过EPSG:32618识别。<br>*Literal<字符串>*
