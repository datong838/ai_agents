---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/geoDistanceLeftJoinV1/",
  "title": "地理距离左合并",
  "page_id": "geoDistanceLeftJoinV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/geoDistanceInnerJoinV1/",
  "next": "/zh/foundry/pb-functions-transform/geoIntersectionInnerJoinV1/",
  "scraped_at": "2026-07-13T05:58:29.248377+00:00"
}
---
...
* **左侧列选择条件** - 将测试左侧输入模式中的所有列是否符合此条件。如果匹配，则该列将在输出中被选中。<br>*ColumnPredicate*
* **右侧列选择条件** - 将测试右侧输入模式中的所有列是否符合此条件。如果匹配，则该列将在输出中被选中。<br>*ColumnPredicate*
* **距离** - 用于合并几何的距离，单位与坐标参考系统一致。<br>*Literal\<DefiniteNumeric>*
* **合并键** - 左侧和右侧输入中的geojson列，用于合并。<br>*Tuple\<Column\<Geometry>, Column\<Geometry>>*
* **左侧数据集** - 用于合并的左侧数据集。<br>*Table*
* **投影坐标系统** - 输入几何将在合并前转换为该坐标系统，并且距离将以给定坐标系统的单位进行测量。格式为"authority:id"，例如UTM区域18N可以用EPSG:32618标识。<br>*Literal<字符串>*
* **右侧数据集** - 用于合并的右侧数据集。<br>*Table*
* *非必填* **右侧列的前缀** - 要添加到右侧所有列的前缀。<br>*Literal<字符串>*
...
* **左侧列选择条件**: <br>columnNameIsIn(<br> columnNames: \[geometryColLhs, lhs-1],<br>)
* **右侧列选择条件**: <br>columnNameIsIn(<br> columnNames: \[geometryColRhs, rhs-1],<br>)
* **距离**: 1640.42
...
* **左侧列选择条件**: <br>columnNameIsIn(<br> columnNames: \[geometryColLhs, lhs-1],<br>)
* **右侧列选择条件**: <br>columnNameIsIn(<br> columnNames: \[geometryCol, col1, arrayCol],<br>)
* **距离**: 10.0
