---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/geoIntersectionInnerJoinV1/",
  "title": "地理交集内合并",
  "page_id": "geoIntersectionInnerJoinV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/geoDistanceLeftJoinV1/",
  "next": "/zh/foundry/pb-functions-transform/geoIntersectionLeftJoinV1/",
  "scraped_at": "2026-07-13T05:58:41.314781+00:00"
}
---
...
* **左侧要选择的列的条件** - 将测试左侧输入架构中的所有列以查看它们是否符合此条件。如果符合，列将被选入输出。<br>*ColumnPredicate*
* **右侧要选择的列的条件** - 将测试右侧输入架构中的所有列以查看它们是否符合此条件。如果符合，列将被选入输出。<br>*ColumnPredicate*
* **合并键** - 用于合并的左侧和右侧输入的GeoJSON列。<br>*Tuple\<Column\<Geometry>, Column\<Geometry>>*
...
* **左侧要选择的列的条件**: <br>allColumns(<br><br>)
* **右侧要选择的列的条件**: <br>allColumns(<br><br>)
...
* **左侧要选择的列的条件**: <br>columnNameIsIn(<br> columnNames: \[geometryColLhs],<br>)
* **右侧要选择的列的条件**: <br>columnNameIsIn(<br> columnNames: \[geometryColRhs],<br>)
* **合并键**: (`geometryColLhs`, `geometryColRhs`)
* **左侧数据集**: ri.foundry.main.dataset.left
* **右侧数据集**: ri.foundry.main.dataset.right
* **右侧列的前缀**: *null*
