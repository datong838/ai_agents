---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/geoIntersectionJoinV1/",
  "title": "几何交集合并",
  "page_id": "geoIntersectionJoinV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/geoPointToPoint3dDistanceInnerJoinV1/",
  "next": "/zh/foundry/pb-functions-transform/geoKnnInnerJoinV1/",
  "scraped_at": "2026-07-13T05:58:31.589983+00:00"
}
---
...
* **连接键** - 用于连接的来自左侧和右侧输入的GeoJSON列列表。如果此列表中的任何列对具有相交的几何图形，则会选中该行。<br>*List\<Tuple\<Column\<Geometry>, Column\<Geometry>>>*
