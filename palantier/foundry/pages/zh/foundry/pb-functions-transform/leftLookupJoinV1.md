---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/leftLookupJoinV1/",
  "title": "左查找合并",
  "page_id": "leftLookupJoinV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/complexLeftJoinV1/",
  "next": "/zh/foundry/pb-functions-transform/manuallyEnteredTableV1/",
  "scraped_at": "2026-07-13T05:58:43.128333+00:00"
}
---
...
* **选择左边列的条件** - 将测试左边输入模式中的所有列是否符合此条件。如果符合，该列将被选中并输出。<br>*ColumnPredicate*
* **选择右边列的条件** - 将测试右边输入模式中的所有列是否符合此条件。如果符合，该列将被选中并输出。<br>*ColumnPredicate*
* **合并条件** - 从左和右输入中列出的列来进行合并。<br>*List\<Tuple\<Column\<Boolean | Byte | Date | Double | Float | Integer | Long | Short | 字符串 | Timestamp>, Column\<Boolean | Byte | Date | Double | Float | Integer | Long | Short | 字符串 | Timestamp>>>*
* **左数据集** - 合并中使用的左数据集。<br>*Table*
* **右数据集** - 合并中使用的右数据集。<br>*Table*
* **非必填** **右边列的前缀** - 为右侧所有列添加的前缀。<br>*Literal<字符串>*
...
* **选择左边列的条件**: <br>columnNameIsIn(<br> columnNames: \[tail\_number, airline],<br>)
* **选择右边列的条件**: <br>columnNameIsIn(<br> columnNames: \[home\_airport],<br>)
...
* **选择左边列的条件**: <br>columnNameIsIn(<br> columnNames: \[tail\_number, airline, factor],<br>)
* **选择右边列的条件**: <br>columnNameIsIn(<br> columnNames: \[home\_airport],<br>)
