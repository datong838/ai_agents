---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/rollUpV1/",
  "title": "汇总",
  "page_id": "rollUpV1",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/repartitionV1/",
  "next": "/zh/foundry/pb-functions-transform/rowSizeV1/",
  "scraped_at": "2026-07-13T05:59:00.359598+00:00"
}
---
...
* **数据集** - 要进行汇总的数据集。<br>*Table*
* **汇总列** - 在聚合时用于汇总数据集的列列表。如果为空，则不应用汇总。<br>*List\<Column\<AnyType>>*
...
* **聚合**: \[<br>alias(<br> alias: max\_price,<br> expression: <br>max(<br> expression: `price`,<br>),<br>)]
...
* **聚合**: \[<br>alias(<br> alias: max\_price,<br> expression: <br>max(<br> expression: `plan_prices`,<br>),<br>)]
