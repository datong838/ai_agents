---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pb-functions-transform/timeBoundedDropDuplicatesV2/",
  "title": "时间限制去重",
  "page_id": "timeBoundedDropDuplicatesV2",
  "category_id": "data-integration",
  "section_id": "pb-functions-transform",
  "previous": "/zh/foundry/pb-functions-transform/textBlockV1/",
  "next": "/zh/foundry/pb-functions-transform/timeBoundedDropOutOfOrderTransformV1/",
  "scraped_at": "2026-07-13T05:59:06.490618+00:00"
}
---
...
* **Dataset** - 要去重行的数据集。<br>*Table*
* **Key expiration time unit** - 等待数据去重的时间单位。<br>*Enum\<Days, Hours, Milliseconds, Minutes, Seconds, Weeks>*
* **Key expiration time value** - 等待数据去重的时间值。<br>*Literal\<Long>*
* *非必填* **Column subset** - 如果指定了任何列，则仅在确定唯一性时使用这些列。<br>*Set\<Column\<AnyType>>*
* *非必填* **Key by columns** - 用于按键对输入进行分区的列。每个去重将在每个不同的键值上并行分别计算。<br>*Set\<Column\<AnyType>>*

## 示例

在所有表中，最近流入的行出现在较高位置。此外，每个示例都使用如下所示的时间限制去重节点：

![时间限制去重节点的示例。](/resources/foundry/pb-functions-transform/time-bounded-drop-duplicates-v2-example.png)
