---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pipeline-builder/transforms-streaming-joins/",
  "title": "在流式Pipeline Builder管道中合并数据",
  "page_id": "transforms-streaming-joins",
  "category_id": "data-integration",
  "section_id": "pipeline-builder",
  "previous": "/zh/foundry/pipeline-builder/unique-id-creation/",
  "next": "/zh/foundry/pipeline-builder/pipeline-builder-llm/",
  "scraped_at": "2026-07-13T05:46:27.934026+00:00"
}
---
...
2. 在批量数据集下，选择下拉菜单并将类型更改为**Snapshot**。

    <img src="../../foundry-docs/pipeline-builder/media/stream-type@2x.png" alt="流类型选择的图片" width=300>

3. 选择您要合并的流。

4. 选择**Join**，然后选择批量数据集作为合并的右侧。

5. 在**Join Type**下，选择**Left Lookup Join**。
...
2. 选择**Join**，然后选择两个流。
3. 在**Join Type**下，选择**Outer Caching Join**。
4. 输入匹配条件。
