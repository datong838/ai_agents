---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/pipeline-builder/unique-id-creation/",
  "title": "在Pipeline Builder中创建唯一ID",
  "page_id": "unique-id-creation",
  "category_id": "data-integration",
  "section_id": "pipeline-builder",
  "previous": "/zh/foundry/pipeline-builder/transforms-geospatial/",
  "next": "/zh/foundry/pipeline-builder/transforms-streaming-joins/",
  "scraped_at": "2026-07-13T05:46:21.637797+00:00"
}
---
...
1. 确定可以唯一标识数据集中每条记录的字符串列。
2. 将选定的字符串列连接起来，形成每条记录的单个字符串。
3. 使用“Hash sha256”计算连接字符串的SHA256哈希。生成的256位哈希可以表示为64字符的十六进制字符串，这将作为每条记录的唯一ID。

![稳定ID的截图](../../../images/foundry/pipeline-builder/concat-sha-id.png)
...
1. 使用“Uniform random number”创建一个随机数。
2. 将列转换为字符串。
3. 使用“Hash sha256”对该列进行哈希。

![随机ID的截图](../../../images/foundry/pipeline-builder/random-id.png)
