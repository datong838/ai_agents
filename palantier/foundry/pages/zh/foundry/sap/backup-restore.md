---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/sap/backup-restore/",
  "title": "备份和恢复 Palantir Foundry Connector 2.0 以用于 SAP 应用程序",
  "page_id": "backup-restore",
  "category_id": "data-integration",
  "section_id": "sap",
  "previous": "/zh/foundry/sap/authorization-roles/",
  "next": "/zh/foundry/sap/sap-source-setup/",
  "scraped_at": "2026-07-13T05:38:43.041066+00:00"
}
---
...
要将表备份为 .zip 文件并下载到文件系统以供后续使用，请运行 `/n/palantir/backup` 事务代码。这将备份所有 Connector 表及其内容。
...
* 要恢复这些表，请运行 `/n/palantir/restore` 事务代码。这将从备份中恢复所有 Connector 表及其内容。
* 检查表的配置参数和内容。
