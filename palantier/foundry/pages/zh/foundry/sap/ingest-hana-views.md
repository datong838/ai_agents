---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/sap/ingest-hana-views/",
  "title": "从SAP导入HANA视图",
  "page_id": "ingest-hana-views",
  "category_id": "data-integration",
  "section_id": "sap",
  "previous": "/zh/foundry/sap/configure-tcode-extraction/",
  "next": "/zh/foundry/sap/oauth2-writeback/",
  "scraped_at": "2026-07-13T05:39:03.339400+00:00"
}
---
...
请注意，这些工具可以从[SAP开发工具 ↗](https://tools.hana.ondemand.com)获取。
...
1. 创建新的ABAP存储库Object并选择**Dictionary View**。
2. 在下一个屏幕中，选择**External View**选项并为您的外部视图命名和描述。
3. 接下来，您可以验证从SAP HANA视图到外部视图的列映射。
4. 您可以通过使用SE16事务代码显示内容来测试您的外部视图。

### 在Foundry中导入HANA视图

Foundry可以通过[sync](/zh/foundry/sap/sap-sync-setup/#foundry-sap-sync)导入您创建的外部视图。
...
此代码定义了一个SAP源适配器配置，`sapType`指定了适配器的类型为HANA视图。`obj`字段应该被替换为实际的HANA视图名称。
