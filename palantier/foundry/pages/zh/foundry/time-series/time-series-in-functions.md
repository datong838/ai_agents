---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/time-series/time-series-in-functions/",
  "title": "函数中的时间序列",
  "page_id": "time-series-in-functions",
  "category_id": "data-integration",
  "section_id": "time-series",
  "previous": "/zh/foundry/time-series/time-series-usage/",
  "next": "/zh/foundry/time-series/foundryts/",
  "scraped_at": "2026-07-13T06:11:12.879671+00:00"
}
---
...
要在函数中使用时间序列，您需要先将时间序列存储在Ontology中。您可以按照[这里](/zh/foundry/time-series/time-series-setup/)的步骤开始。

一旦您的时间序列存储在Ontology中，我们需要为我们的时间序列函数[创建代码库](/zh/foundry/functions/getting-started/)。在这个代码库中，我们首先[导入Ontology类型](/zh/foundry/functions/foo-getting-started/#import-ontology-types)，以便引用存储在这些Ontology类型中的时间序列。

现在您可以在函数中使用时间序列了。

## 在函数中使用时间序列

要在函数中访问时间序列，首先在您的代码库中创建一个[Object支持的函数](/zh/foundry/functions/foo-getting-started/#add-an-object-backed-function)。这些函数可以直接访问Ontology中的时间序列属性。当您编写好函数后，有两种方式来运行您的新函数。您可以选择[在实时预览中测试您的函数](/zh/foundry/functions/foo-getting-started/#test-in-live-preview)或[发布您的函数](/zh/foundry/functions/foo-getting-started/#publish-the-new-function)并在整个平台的其他应用中开始使用它。
