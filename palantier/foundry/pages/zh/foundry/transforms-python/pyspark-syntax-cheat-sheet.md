---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/transforms-python/pyspark-syntax-cheat-sheet/",
  "title": "语法备忘单",
  "page_id": "pyspark-syntax-cheat-sheet",
  "category_id": "data-integration",
  "section_id": "transforms-python",
  "previous": "/zh/foundry/transforms-python/pyspark-coming-from-python/",
  "next": "/zh/foundry/transforms-python/pyspark-style-guide/",
  "scraped_at": "2026-07-13T06:08:09.493131+00:00"
}
---
...
* [常用模式](#common-patterns)
  * [日志输出](#logging-output)
  * [导入函数和类型](#importing-functions--types)
  * [筛选](#filtering)
  * [合并](#joins)
  * [列操作](#column-operations)
  * [类型转换和合并空值及重复值](#casting--coalescing-null-values--duplicates)
* [字符串操作](#string-operations)
  * [字符串筛选](#string-filters)
  * [字符串函数](#string-functions)
* [数字操作](#number-operations)
* [日期和时间戳操作](#date--timestamp-operations)
* [数组操作](#array-operations)
* [聚合操作](#aggregation-operations)
* [高级操作](#advanced-operations)
  * [重新分区](#repartitioning)
  * [UDFs（用户定义函数）](#udfs-user-defined-functions)

如果您找不到所需内容，可能会在 [PySpark 官方文档 ↗](https://spark.apache.org/docs/latest/api/python/) 中找到。

## 常用模式

#### [日志输出](/zh/foundry/transforms-python/pyspark-logging/)
...
#### [筛选](/zh/foundry/transforms-python/pyspark-filtering/)
...
#### [合并](/zh/foundry/transforms-python/pyspark-joins/)
...
#### [列操作](/zh/foundry/transforms-python/pyspark-columns/)
...
#### [转换和合并空值及重复项](/zh/foundry/transforms-python/pyspark-other/#dealing-with-null-values)
...
#### [字符串筛选](/zh/foundry/transforms-python/pyspark-filtering/)
...
#### [字符串函数](/zh/foundry/transforms-python/pyspark-strings/)
...
## [数字运算](/zh/foundry/transforms-python/pyspark-math/)
...
## [日期和时间戳操作](/zh/foundry/transforms-python/pyspark-dates/)
...
## [数组和结构体操作](/zh/foundry/transforms-python/pyspark-other/#collections)
...
## [聚合操作](/zh/foundry/transforms-python/pyspark-aggregation/)
...
#### [UDFs（用户定义函数）](/zh/foundry/transforms-python/pyspark-udfs/)
