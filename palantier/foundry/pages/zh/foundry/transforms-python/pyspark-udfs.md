---
{
  "source_url": "https://www.palantir.com/docs/zh/foundry/transforms-python/pyspark-udfs/",
  "title": "概念: 用户定义函数",
  "page_id": "pyspark-udfs",
  "category_id": "data-integration",
  "section_id": "transforms-python",
  "previous": "/zh/foundry/transforms-python/pyspark-queries/",
  "next": "/zh/foundry/transforms-python/pyspark-filtering/",
  "scraped_at": "2026-07-13T06:08:13.212932+00:00"
}
---
...
声明后，UDF 的工作方式类似于内置的 PySpark 函数，如 `concat`、`date_diff`、`trim` 等。
...
假设我们想从以下天气格式中获取低温，在这种情况下为`55`。我们可以编写以下普通Python函数，
...
我们将围绕我们的函数`extract_low_temperature`创建一个UDF，以将其集成到我们的PySpark查询中。创建UDF涉及在PySpark的类型系统中提供我们的函数及其预期返回类型。
